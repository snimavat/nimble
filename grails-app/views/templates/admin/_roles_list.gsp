  ...
  <table class="table table-striped">
    ...
    <g:each in="${roles}" status="i" var="role">
      <tr>
        ...
        <td>
          <g:link controller="role" action="show" id="${role.id.encodeAsHTML()}" class="btn btn-info">
            <g:message code="nimble.link.view" />
          </g:link>
          <g:if test="${role.protect == false}">
            <button onClick="removeRole('${ownerID.encodeAsHTML()}', '${role.id.encodeAsHTML()}');" class="btn btn-danger">
