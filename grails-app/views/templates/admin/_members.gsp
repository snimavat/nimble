<h3>
   <g:message code="nimble.template.members.heading" />
</h3>
<div id="currentmembers"> </div>
<g:if test="${!protect}">
   <div id="showaddmembers">
      <a id="showaddmembersbtn" class="btn btn-primary btn-small">
   ...
   <div id="addmembers">
      <h4>
         <g:message code="nimble.template.members.add.heading" />
      </h4>
      <p>
         <g:message code="nimble.template.members.add.user.descriptive" />
            ...
            <g:if test="${groupmembers}">
               <div class="control-group">
                  ...
                  <label class="radio inline">
                     <g:radio name="memberselect" id="searchmemberusers" checked="true" value="users"/>
                     &nbsp;  
                     <g:message code="nimble.label.users" />
                  </label>
               </div>
            </g:if>
      ...
      <div id="memberaddusers">
         <form class="well form-inline">
            <div class="control-group">
               ...
               <button type="button" onClick="searchMembers(${parent.id.encodeAsHTML()});" class="btn btn-primary btn-small">
                  <i class="icon-search icon-white"></i>
                  <g:message code="nimble.link.search" />
               </button>
               <button type="button" id="closeaddmembersbtn" class="btn btn-warning btn-small">
         ...
         <div id="memberaddgroups">
            ...
            <form class="well form-inline">
               <div class="control-group">
                  ...
                  <button type="button" onClick="searchGroupMembers(${parent.id.encodeAsHTML()});" class="btn btn-primary btn-small">
                     <i class="icon-search icon-white"></i>
                     <g:message code="nimble.link.search" />
                  </button>
                  <button type="button" id="closeaddgroupmembersbtn" class="btn btn-warning btn-small">
                     <g:message code="nimble.link.close" />
                  </button>
               </div>
            </form>
