      ...
      <div class="container">
         <div class="login">
            ...
            <div class="logininteraction">
                  ...
                  <div id="local" class="loginmethod">
                     ...
                     <g:form id="locallogin" action="signin" name="signin">
                        ...
                        <fieldset class="loginbuttons">
                           <button type="submit" class="button darkbutton icon icon_user_green">
                              <g:message code="nimble.link.login.basic" />
                           </button>
                        </fieldset>
                     </g:form>
                     <div class="accountoptions">
                        <g:link controller="account" action="forgottenpassword" class="textlink icon icon_flag_purple">
                           <g:message code="nimble.link.forgottenpassword" />
                        </g:link>
                        <g:if test="${registration}">
                           <a href="#" id="accountcreationpolicybtn" class="textlink icon icon_user_go">
                              <g:message code="nimble.link.newuser" />
                           </a>
                        </g:if>
                     </div>
                  </div>
               ...
               <g:if test="${facebook}">
                  <div id="facebook" class="loginmethod externalloginmethod">
                     <h2>
                        <g:message code="nimble.template.login.facebook.heading" />
                     </h2>
                     <p>
                     ...
                     <div id="loginfacebookcontinue">
                        <a href="${createLink(controller: "auth", action: "facebook")}" class="button icon icon_user_green">
                        <g:message code="nimble.link.login.basic" />
                        </a>
                     </div>
               ...
               <g:if test="${openid}">
                  <div id="google" class="loginmethod externalloginmethod">
                     <h2>
                        <g:message code="nimble.template.login.google.heading" />
                     </h2>
                     <p>
                     ...
                     <p>
                        <a href="${createLink(controller: "auth", action: "googlereq")}" class="button icon icon_user_green">
                        <g:message code="nimble.link.login.basic" />
                        </a>
                     </p>
                  </div>
                  <div id="yahoo" class="loginmethod externalloginmethod">
                     <h2>
                        <g:message code="nimble.template.login.yahoo.heading" />
                     </h2>
                     <p>
                     ...
                     <p>
                        <a href="${createLink(controller: "auth", action: "yahooreq")}" class="button icon icon_user_green">
                        <g:message code="nimble.link.login.basic" />
                        </a>
                     </p>
                  </div>
                  <div id="openid" class="loginmethod externalloginmethod">
                     <h2>
                        <g:message code="nimble.template.login.openid.heading" />
                     </h2>
                     <p>
                     ...
                     <g:form controller="auth" action="openidreq">
                        <strong>
                           <g:message code="nimble.template.login.openid.identifier" />
                        </strong>
                        <input id="openiduri" type="text" name="openiduri" class="easyinput" value="http://"/>
                        <button type="submit" class="button icon icon_user_green">
                           <g:message code="nimble.link.login.basic" />
                        </button>
                     </g:form>
                  </div>
                  <div id="blogger" class="loginmethod externalloginmethod">
                     <h2>
                        <g:message code="nimble.template.login.blogger.heading" />
                     </h2>
                     <p>
                     ...
                     <g:form controller="auth" action="bloggerreq">
                        <label for="openiduri" class="append-1">
                           <g:message code="nimble.template.login.blogger.identifier" />
                        </label>
                  ...
                  <div id="wordpress" class="loginmethod externalloginmethod">
                     <h2>
                        <g:message code="nimble.template.login.wordpress.heading" />
                     </h2>
                     <p>
                     ...
                     <g:form controller="auth" action="wordpressreq">
                        <label for="openiduri" class="append-1">
                           <g:message code="nimble.template.login.wordpress.identifier" />
                        </label>
                        <input id="openiduri" type="text" name="openiduri" class="easyinput"/>
                        <fieldset>
                           <button type="submit" class="button darkbutton icon icon_user_green">
                  ...
                  <div id="technorati" class="loginmethod externalloginmethod">
                     <h2>
                        <g:message code="nimble.template.login.technorati.heading" />
                     </h2>
                     <p>
                     ...
                     <g:form controller="auth" action="technoratireq">
                        <label for="openiduri" class="append-1">
                           <g:message code="nimble.template.login.technorati.identifier" />
                        </label>
                  ...
                  <div id="flickr" class="loginmethod externalloginmethod">
                     <h2>
                        <g:message code="nimble.template.login.flickr.heading" />
                     </h2>
                     <p>
                     ...
                     <p>
                        <a href="${createLink(controller: "auth", action: "flickreq")}" class="button icon icon_user_green">
                        <g:message code="nimble.link.login.basic" />
                        </a>
                     </p>
                  </div>
            ...
            <div class="loginchoices">
               <g:if test="${local}">
                  <h2>
                     <a href="#" onClick="changeLogin('local');" class="icon icon_user_go">
                        <g:message code="nimble.template.login.local.heading" />
                     </a>
                  </h2>
               </g:if>
               <h2>
                  <g:message code="nimble.template.login.external.heading" />
               </h2>
               <table>
                  <tbody>
                     <tr>
                        <td>
                           <g:if test="${openid}">
                              <a href="#" class="" onClick="changeLogin('openid');">
                                 <n:socialimg name="openid" size="64" alt="Login using OpenID"/>
                                 <g:message code="nimble.label.openid" />
                              </a>
                           </g:if>
                        </td>
                        <td>
                           <g:if test="${facebook}">
                              <a href="#" class="" onClick="changeLogin('facebook');">
                                 <n:socialimg name="facebook" size="64" alt="Login using Facebook"/>
                                 <g:message code="nimble.label.facebook" />
                              </a>
                           </g:if>
                        </td>
                     </tr>
                     <g:if test="${openid}">
                        <tr>
                           <td>
                              <a class="" onClick="changeLogin('google');">
                                 <n:socialimg name="google" size="64" alt="Login using Google"/>
                                 <g:message code="nimble.label.google" />
                              </a>
                           </td>
                           <td>
                              <a class="" onClick="changeLogin('yahoo');">
                                 <n:socialimg name="yahoo" size="64" alt="Login using Yahoo!"/>
                                 <g:message code="nimble.label.yahoo" />
                              </a>
                           </td>
                        </tr>
                        <tr>
                           <td>
                              <a href="#" class="" onClick="changeLogin('blogger');">
                                 <n:socialimg name="blogger" size="64" alt="Login using Blogger"/>
                                 <g:message code="nimble.label.blogger" />
                              </a>
                           </td>
                           <td>
                              <a href="#" class="" onClick="changeLogin('wordpress');">
                                 <n:socialimg name="wordpress" size="64" alt="Login using Wordpress"/>
                                 <g:message code="nimble.label.wordpress" />
                              </a>
                           </td>
                        </tr>
                        <tr>
                           <td>
                              <a href="#" class="" onClick="changeLogin('technorati');">
                                 <n:socialimg name="technorati" size="64" alt="Login using Technorati"/>
                                 <g:message code="nimble.label.technorati" />
                              </a>
                           </td>
                           <td>
                              <a href="#" class="" onClick="changeLogin('flickr');">
                                 <n:socialimg name="flickr" size="64" alt="Login using Flickr"/>
                                 <g:message code="nimble.label.flickr" />
                              </a>
                           </td>
                        </tr>
                     </g:if>
            ...
            <div class="span12">
               <div class="login-block well">
                  ...
                  <div class="pull-right" id="login-options">
                     ...
                     <g:if test="${registration}">
                        | 
                        <g:link controller="account" action="createuser" class="textlink icon icon_user_go">
                           <g:message code="nimble.link.newuser" />
                        </g:link>
                     </g:if>
                  </div>
